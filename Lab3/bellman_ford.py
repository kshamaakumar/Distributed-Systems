...
class BellmanFord(object):
    """
    Graph suitable for Bellman-Ford Algorithm. Edges are added with the add_edge method. Shortest paths (and cycles)
    ...
    def add_edge(self, from_vertex, to_vertex, weight):
        ...
        if from_vertex == to_vertex:
            raise ValueError('{} -> {}: {}'.format(from_vertex, to_vertex, weight))
